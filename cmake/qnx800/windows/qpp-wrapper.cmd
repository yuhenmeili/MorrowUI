...
if errorlevel 1 goto run_qpp_raw
...
:run_qpp
"%MORROW_QNX_SDK_ROOT%\host\win64\x86_64\usr\bin\q++.exe" !MORROW_QNX_ARGS!
exit /b %errorlevel%

:run_qpp_raw
"%MORROW_QNX_SDK_ROOT%\host\win64\x86_64\usr\bin\q++.exe" %*
exit /b %errorlevel%
