...
//（KAWASE_BACKDROP_BLUR_PROPOSAL.md §5.1 阶段 3c / §5.6）。
//
// 每顶点数据由 BackdropBlurManager 在 CPU 侧按面片烘焙（S1 单层级 L0'）：
...
//   a_tangent  = (displaySize.x, displaySize.y, 0, 0) —— 复用 Tangent 语义
