...
public:
    ...
    /// 世界矩阵版本号：世界矩阵实际重算后递增，供子节点检测父链变化。
...
private:
    ...
    /// Local transform data revision. Incremented whenever transform data changes.
    ...
    Transform* m_cachedWorldParent = nullptr;
